...
1. **Scale Normalization:** Raw SWC files are ingested. To prevent metrics from exploding out of VQ codebook bounds, the SWC is scaled so its bounding box diagonal matches the CCFv3 training baseline (e.g., ~500 microns).
